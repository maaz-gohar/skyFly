...
const handleBooking = async () => {
  ...
  if (!flightId || !contactEmail || !contactNumber) {
  ...
  try {
    const result = await createBooking(bookingData); // 👈 this returns response from API
    const booking = result?.data || result; // adapt this based on actual API response shape
    ...
    // ✅ Store booking ID in AsyncStorage
    await AsyncStorage.setItem("bookingId", booking._id);

    // ✅ Proceed to Payment screen
    navigation.navigate("Payment", {
      bookingId: booking._id, // optional: pass via navigation too
      totalPrice,
    });
  } catch (err) {
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        >
          ...
          <View style={styles.flightPathContainer}>
            <View style={styles.locationTimeContainer}>
              ...
              <Text style={[styles.locationText, { color: theme.black }]}>
                {flight.origin}
              </Text>
            </View>

            <View style={styles.durationContainer}>
              <Text style={[styles.durationText, { color: theme.black }]}>
                {flight.duration}
              </Text>
        ...
        <View style={styles.tabContainer}>
          ...
          <TouchableOpacity
            style={[
              styles.tabButton,
              selectedTab === "passenger" && styles.activeTabButton,
            ]}
          ...
          >
            <Text
              style={[
                styles.tabText,
                selectedTab === "passenger" && styles.activeTabText,
              ]}
            >
              Passenger Info
            </Text>
        ...
        {selectedTab === "details" ? (
          <Card
            style={[styles.detailsCard, { backgroundColor: theme.lightGray }]}
          >
          ...
          >
            ...
            <View style={styles.formContainer}>
              <Input
                ...
                onChangeText={(text) =>
                  setPassengerDetails({ ...passengerDetails, firstName: text })
                }
              ...
              <Input
                ...
                onChangeText={(text) =>
                  setPassengerDetails({ ...passengerDetails, lastName: text })
                }
                autoCapitalize="words"
              />
              ...
              <Input
                ...
                onChangeText={(text) =>
                  setPassengerDetails({ ...passengerDetails, dob: text })
                }
              ...
              <View style={styles.rowContainer}>
                <View style={styles.genderContainer}>
                  <Text style={[styles.inputLabel, { color: theme.black }]}>
                    Gender
                  </Text>
              ...
              <Input
                ...
                onChangeText={(text) =>
                  setPassengerDetails({ ...passengerDetails, email: text })
                }
              ...
              <Input
                ...
                onChangeText={(text) =>
                  setPassengerDetails({ ...passengerDetails, phone: text })
                }
              ...
              <View style={styles.optionsSection}>
                <Text style={[styles.optionLabel, { color: theme.black }]}>
                  Meal Preference
                </Text>
                <View style={styles.optionsRow}>
                  <TouchableOpacity
                    style={[
                      styles.optionButton,
                      { backgroundColor: theme.white },
                      selectedMeal === "Regular" && styles.selectedOptionButton,
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        styles.optionText,
                        { color: theme.black },
                        selectedMeal === "Regular" && styles.selectedOptionText,
                      ]}
                    >
                      Regular
                    </Text>
                  ...
                  <TouchableOpacity
                    style={[
                      styles.optionButton,
                      { backgroundColor: theme.white },
                      selectedMeal === "Vegan" && styles.selectedOptionButton,
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        styles.optionText,
                        { color: theme.black },
                        selectedMeal === "Vegan" && styles.selectedOptionText,
                      ]}
                    >
                      Vegan
                    </Text>
                ...
                <View style={styles.optionsRow}>
                  <TouchableOpacity
                    style={[
                      styles.optionButton,
                      { backgroundColor: theme.white },
                      selectedBaggage === "20kg" && styles.selectedOptionButton,
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        styles.optionText,
                        { color: theme.black },
                        selectedBaggage === "20kg" && styles.selectedOptionText,
                      ]}
                    >
                      20kg
                    </Text>
                  ...
                  <TouchableOpacity
                    style={[
                      styles.optionButton,
                      { backgroundColor: theme.white },
                      selectedBaggage === "25kg" && styles.selectedOptionButton,
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        styles.optionText,
                        { color: theme.black },
                        selectedBaggage === "25kg" && styles.selectedOptionText,
                      ]}
                    >
                      25kg (+$30)
                    </Text>
                  ...
                  <TouchableOpacity
                    style={[
                      styles.optionButton,
                      { backgroundColor: theme.white },
                      selectedBaggage === "30kg" && styles.selectedOptionButton,
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        styles.optionText,
                        { color: theme.black },
                        selectedBaggage === "30kg" && styles.selectedOptionText,
                      ]}
                    >
                      30kg (+$50)
                    </Text>
        ...
        <Card style={[styles.priceCard, { backgroundColor: theme.lightGray }]}>
          ...
          <View style={styles.priceRow}>
            ...
            <Text style={[styles.priceValue, { color: theme.black }]}>
              ${totalPrice}
            </Text>
          </View>
          <View style={styles.priceRow}>
          ...
          <View style={styles.totalRow}>
            <Text style={[styles.totalLabel, { color: theme.black }]}>
              Total
            </Text>
