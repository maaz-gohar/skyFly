    ...
    try {
      ...
      if (
        ...
        Alert.alert(
          ...
          "Please log in again to view your bookings.",
          [
            {
              text: "Go to Login",
    ...
    switch (filter) {
      case "upcoming":
        return bookings.filter(
          (booking) =>
            new Date(booking.flight.departureTime) > now &&
    ...
    <Card style={[styles.bookingCard, { backgroundColor: theme.white }]}>
      <View style={styles.bookingHeader}>
        <View style={styles.bookingInfo}>
          ...
          <Text style={[styles.flightNumber, { color: theme.gray }]}>
      ...
      <View style={styles.flightRoute}>
        <View style={styles.routePoint}>
          <Text style={[styles.routeCity, { color: theme.black }]}>
            {item.flight.origin}
          </Text>
          <Text style={[styles.routeTime, { color: theme.gray }]}>
    ...
    return (
      ...
      >
        ...
        <View style={styles.authPrompt}>
          ...
          <Text style={[styles.authPromptTitle, { color: theme.black }]}>
            Authentication Required
          </Text>
          <Text style={[styles.authPromptText, { color: theme.gray }]}>
        ...
        {[
          ...
          <TouchableOpacity
            ...
            style={[
              ...
              {
                backgroundColor:
                  filter === tab.key ? theme.primary : "transparent",
                borderBottomColor:
                  filter === tab.key ? theme.primary : "transparent",
              },
            ]}
            ...
            <Text
              style={[
                styles.filterTabText,
                {
                  ...
                  fontFamily:
                    filter === tab.key ? FONTS.semiBold : FONTS.regular,
                },
              ]}
            >
              {tab.label}
